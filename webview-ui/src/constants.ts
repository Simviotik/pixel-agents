...
// Simviotik fork: shrunk from upstream's 2-20s pause / 2-4min seat rest so
// inactive characters read as "always ambient-alive" (brief pauses only)
// instead of standing frozen for long stretches between wander walks.
