...
function GitHubIcon() {
  return (
    <svg viewBox="0 0 16 16" className="size-20 shrink-0" fill="currentColor" aria-hidden="true">
    ...
    >
      ...
      <div className="border-t border-border mt-4 flex">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 py-6 px-10 border-r border-border flex items-center justify-center gap-8 text-lg no-underline cursor-pointer transition-colors duration-200 hover:text-accent-bright"
        >
          <GitHubIcon />
          View on GitHub
        </a>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 py-6 px-10 flex items-center justify-center gap-8 text-lg no-underline cursor-pointer transition-colors duration-200 hover:text-accent-bright"
        >
          <DiscordIcon />
          Join our Discord!
        </a>
